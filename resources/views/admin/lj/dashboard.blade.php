                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col ">
                                            <label class="col-md-12">ID  test <span class="red">*</span></label>
...
$("#lj_result_date").change(function(){ //alert($("#lj_result_date").val());
	  if($("#lj_result_date").val()==null ||$("#lj_result_date").val()==""){
		 $("#lj_butt").attr("disabled",true);  
		  ...
		  //alert($('#test_id').val());
		  //alert($("#culture_smear").val());
		if(($("#test_id").val()==null ||$("#test_id").val()=="")||($("#culture_smear").val()==null ||$("#culture_smear").val()=="")){ //alert("here");
		    $("#lj_butt").attr("disabled",true);
		}else{ //alert("there");
		    if($("#final_result").val()==null ||$("#final_result").val()==""){
				$("#lj_butt").attr("disabled",true);
			}else{
			    $("#lj_butt").attr("disabled",false);
			}
