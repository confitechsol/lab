		...
		<div class="container-fluid">
              <div class="row page-titles">
                  <div class="col-md-12 col-12 align-self-center">
                      <h3 class="text-themecolor m-b-0 m-t-0" style="text-align: center;margin-top:10px;">Enrolment with Nikshay ID</h3>
                  </div>
              </div>
                            ...
                            <div class="card-block">
                                <div class="col-lg-12 col-lg-12 col-md-12 col-sm-12 col-sm-12" style="width: auto;">
                                    <table border="1" id="example" class="table table-striped table-bordered responsive col-lg-12" cellspacing="0" cellpadding="10" width="100%">
                                        <thead>
                                            <tr>
                                              <th class="hide" align="left">ID</th>
                                              <th align="left">Enrolment ID</th>
                                              <th align="left">Sample ID</th>
                                              <th align="left">Receive Date</th>
                                              <th align="left">Reason for Test</th>
