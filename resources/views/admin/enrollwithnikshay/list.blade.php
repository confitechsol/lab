    ...
    <div class="container-fluid">
      ...
      <div class="row page-titles">
          <div class="col-md-5 col-8 align-self-center">
              <h3 class="text-themecolor m-b-0 m-t-0">Enrolment with Nikshay ID</h3>			 
			  <ul class="color-code">
				<li><strong>Color Code</strong></li>
				<li><span class="white-color"><i class="mdi mdi-checkbox-blank" aria-hidden="true"></i></span>Action to be taken</li>
				<li><span class="blue-color"><i class="mdi mdi-checkbox-blank" aria-hidden="true"></i></span>Nikshay ID given & ready for hit to Nikshay Server</li>
				...
				<li>&nbsp;</li>
				<li>Want to change Nikshay ID?  <a href="{{ url('/changenikshayid') }}" target="_blank" rel="noopener noreferrer" class="btn-sm btn-danger">Click Here</a></li>
			  </ul>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Enrolment with Nikshay ID</h4>
        </div>
         <!----------loader------------>
				<div id="pageloader">
				...
				<!----------loader------------>
         <form class="form-horizontal form-material" action="{{ url('/enrollwithnikshay') }}" method="post" enctype='multipart/form-data' id="cbnaat_result">
                  @if(count($errors))
          ...
          <input type="text" class="form-control form-control-line sampleId" name="sampleid" id="sampleid" readonly>
                ...
                <label class="col-md-12"><h5>Nikshay ID:<span class="red">*</span></h5></label>
                    <div class="col-md-12">
            <input type="text" class="form-control form-control-line" name="nikshayid" id="nikshayid" onkeypress="return isNumberKey(event)"  onchange="try{setCustomValidity('')}catch(e){}" required >
                   </div>
