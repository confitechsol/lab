                                                 ...
                                                 <div class="col">
                                                      ...
                                                      <div class="col-md-12">
                                                        <select name="is_accepted[]" id="sample_statusA" class="form-control form-control-line sample_status" disabled >
                                                          <option value="">--Select--</option>
                                                          <option value="{{ $value['is_accepted'] }}" @if($value['is_accepted'] =='Accepted') selected="selected" @endif>Accepted</option>
                                                          <option value="{{ $value['is_accepted'] }}" @if($value['is_accepted'] =='Rejected') selected="selected" @endif >Rejected</option>
                                                        </select>
                                                     </div>
                                                </div>                                                
