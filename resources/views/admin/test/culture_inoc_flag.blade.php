            ...
            <div class="container-fluid">
              <div class="row page-titles">
                  <div class="col-md-5 col-8 align-self-center">
                      <h3 class="text-themecolor m-b-0 m-t-0">Culture Inoculation (Flagging)</h3>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Culture Inoculation (Flagging)</h4>
        </div>
         ...
         <form class="form-horizontal form-material" action="{{ url('/pcr') }}" method="post" enctype='multipart/form-data' id="cbnaat_result">
            ...
            <div class="modal-body">
                ...
                <label class="col-md-12"><h5>GU:</h5></label>
                    <div class="col-md-12">
                        <input type="number" class="form-control form-control-line sampleId" name="mgit" value="" id="mgit">

                       </input>
                   </div>
                <br>
                <label class="col-md-12"><h5>Date of flagging  by MGIT:</h5></label>
                    <div class="col-md-12">
