<!-- Modal Dialog -->
<div class="modal fade" id="ict" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p></p>
        <form class="form-horizontal form-material" action="{{ url('/further_lc_flagged_mgit/ict') }}" method="post" id="ictform">
