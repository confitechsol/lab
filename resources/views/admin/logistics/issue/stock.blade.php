...
@section('logistics-title', 'Item Issue')

@section('secondary-nav')
    <a href="{{ route('logistics.issue.cart.index') }}"
       class="btn-sm btn-info">Issue Cart (<span id="issue-cart-count">0</span>)</a>
@endsection
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm" >
                        ...
                        <tr>
                            ...
                            <th width="80" class="text-center">Issue Quantity</th>
                        ...
                        @foreach( $stock as $stock_item )
                            ...
                            <tr data-item='{!! json_encode( $stock_item ) !!}'
                                class="{{ $stock_item->is_in_issue_cart ? 'bg-exists' : ($stock_item->below_reorder_level ? 'bg-alert' : '') }}">
                            ...
                            <!--td class="text-center">{{ $stock_item->effective_stock }}</td-->
                                ...
                                <td><a href="#" class="btn btn-info btn-sm issue-add-to-cart"><i class="fas fa-plus"></i></a></td>
                            </tr>
                        @endforeach
