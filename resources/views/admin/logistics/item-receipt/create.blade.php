                        ...
                        <form class="well form-horizontal">
                            <div class="cls_left">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 control-label"><strong>Select Document Type *</strong></label>
    ...
    <div class="card">
        <div class="card-block">
            ...
            <div class="form-horizontal form-material">
                ...
                <h3 class="text-center" style="background: #1e88e5;border: 1px solid #1e88e5; color: #FFFFFF;">List of Items for Consumable that are sent from other locations</h3>
