...
class MicroController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($request->sentstep)) {//Add test from microbiologist
            ...
            // If process comes from Cancel Process Page, then remove
            ...
            foreach ($request->sentstep as $key => $sent_service) {
               ...
               /* $tag = '';
                ...
                if( count( $sent_service_arr ) > 1 ){
                   ...
                   // if( $tag === 'LPA2' ) $tag = '2nd line LPA';
                    ...
                    if ($sent_service == ServiceLog::TYPE_LPA_1ST_LINE) {
                        $tag = '1st line LPA';
                        $sent_service = ServiceLog::TYPE_DNA_EXTRACTION;
                    }

                    if ($sent_service == ServiceLog::TYPE_LPA_2ND_LINE) {
                        $tag = '2nd line LPA';
                        $sent_service = ServiceLog::TYPE_DNA_EXTRACTION;
                    }
                ...
                /*if( $sent_service == ServiceLog::TYPE_STORAGE ){
               ...
               /* $tag="";
                ...
                ServiceLog::create([
                    ...
                    'status' => $status,
                    'tag' => !empty($request->lpa_tag)?$request->lpa_tag:"",
...
value='".$addtestdata->id."' name='addtest[]' type='checkbox' ".$checked." ".$readonly.">".$addtestdata->name."</div>";
    ...
    { 
		  ...
		  if($tag!=null || !is_null($tag)) { //echo "hh"; die;
