    ...
    public function edit($id)
    {
     ...
     // dd($master_socioeco_values);
        ...
        if($name){
            ...
            $data['landmark_tu'] = Tbunits_master::select('m_tbunits_relation.id','m_tbunits_relation.TBUnitCode','m_tbunits_relation.TBUnitName')->where('m_tbunits_relation.DTOCode',$data['patient']->landmark_district)->where('m_tbunits_relation.STOCode',$data['patient']->landmark_state)->get();
			//dd($data['patient']);
